    ...
    return incoming ? (
        <div className="max-w-lg mr-auto" >
            ...
            <div className="mb-2 rounded-2xl rounded-tl-none px-5 py-3 bg-stone-600">
                {type === "text" ? <p dangerouslySetInnerHTML={{ __html: text }}></p> : <Waveform audioUrl={content} />}
            </div>
        ...
        <div className="max-w-lg ml-auto" >
            <div className="mb-2 rounded-2xl rounded-br-none bg-yellow-900 px-5 py-3">
                {type === "text" ? <p className="text-white" dangerouslySetInnerHTML={{ __html: text }}></p> : <Waveform audioUrl={content} />}
            </div>
